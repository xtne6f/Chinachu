...
function Category(nibble)
  return ({'news','sports','information','drama','music','variety','cinema','anime','documentary','theater','hobby','welfare'})[math.floor(nibble/256)+1] or 'etc'
end
...
function NetworkType(onid)
  return onid==4 and 'BS' or (onid==6 or onid==7) and 'CS' or (0x7880<=onid and onid<=0x7fef) and 'GR' or 'SKY'
end
